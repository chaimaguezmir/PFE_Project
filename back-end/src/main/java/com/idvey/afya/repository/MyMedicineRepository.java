...
public interface MyMedicineRepository extends JpaRepository<MyMedicine, UUID> {
	...
	List<MyMedicine> findByPharmacyBoxIdAndNameContaining(@Param("pharmacyBoxId") UUID pharmacyBoxId,
	...
	boolean existsByPharmacyBox_IdAndNameAndMedicine_IsNull(@Param("pharmacyBoxId") UUID pharmacyBoxId,
			@Param("name") String name);
	...
	Optional<MyMedicine> findByPharmacyBoxIdAndMedicineId(@Param("pharmacyBoxId") UUID pharmacyBoxId,
