...
public interface ReminderRepository extends JpaRepository<Reminder, UUID> {
	...
	@Query("SELECT r FROM Reminder r " +
			"JOIN FETCH r.treatment t " +
			"JOIN FETCH t.prescription p " +
			"JOIN FETCH t.myMedicine mm " +
	...
	@Query("SELECT DISTINCT mm FROM Reminder r " +
			"JOIN r.treatment t " +
			"JOIN t.myMedicine mm " +
			"JOIN t.prescription p " +
			"WHERE p.user.id = :userId")
	...
	@Query("SELECT r FROM Reminder r " +
			"JOIN r.treatment t " +
			"WHERE t.myMedicine.id = :myMedicineId " +
			"ORDER BY r.reminderDateTime ASC")
