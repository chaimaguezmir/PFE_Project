...
public class Reminder {
    ...
    private LocalDateTime reminderDateTime; // Full date and time for the reminder (e.g., 2025-07-21T08:30, 2025-07-22T14:00)
    ...
    @Builder.Default
    private ReminderStatus status = ReminderStatus.SCHEDULED; // Current status of the reminder
