...
public final class UserDocs {
	...
	@ApiResponses({
			@ApiResponse(responseCode = "200", description = "Profile retrieved successfully",
					content = @Content(mediaType = "application/json",
							schema = @Schema(
									implementation = com.idvey.afya.payload.response.UserProfileResponse.class))),
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Profile image deleted successfully"),
