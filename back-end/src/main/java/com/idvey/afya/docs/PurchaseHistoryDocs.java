...
public final class PurchaseHistoryDocs {
    ...
    private PurchaseHistoryDocs() {} // no instantiation
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Purchase recorded successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = com.idvey.afya.payload.response.PurchaseHistoryResponse.class))),
    ...
    @Retention(RetentionPolicy.RUNTIME)
    @Documented
    @Operation(summary = "Get purchases by date range", description = "Retrieves purchases within a specific date range")
    @ApiResponses({
