...
public final class GroupMedicalDocs {
    ...
    private GroupMedicalDocs() {} // no instantiation
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Prescriptions retrieved successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = com.idvey.afya.payload.response.PrescriptionResponse.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Reminders with medication details retrieved successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = com.idvey.afya.payload.response.ReminderWithMedicationResponse.class))),
            @ApiResponse(responseCode = "403", description = "Access denied - insufficient group permissions"),
            @ApiResponse(responseCode = "404", description = "User or group not found"),
            @ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Group medical overview retrieved successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = com.idvey.afya.payload.response.GroupMemberMedicalOverviewResponse.class))),
            @ApiResponse(responseCode = "403", description = "Access denied - insufficient group permissions"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "User medical summary retrieved successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = com.idvey.afya.payload.response.UserMedicalSummaryResponse.class))),
            @ApiResponse(responseCode = "403", description = "Access denied - insufficient group permissions"),
            @ApiResponse(responseCode = "404", description = "User or group not found"),
            @ApiResponse(responseCode = "401", description = "Unauthorized")
    })
