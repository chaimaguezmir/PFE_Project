...
public class UserController {
	...
	@UserDocs.GetProfile
	@GetMapping("/profile")
	public ResponseEntity<UserProfileResponse> getUserProfile(@AuthenticationPrincipal UserDetailsImpl currentUser) {
	...
	@PutMapping("/profile")
	public ResponseEntity<UserProfileResponse> updateUserProfile(@AuthenticationPrincipal UserDetailsImpl currentUser,
	...
	public ResponseEntity<MessageResponse> uploadProfileImage(@AuthenticationPrincipal UserDetailsImpl currentUser,
			@RequestParam("file") MultipartFile file) {

		try {
			String imageUrl = userService.uploadProfileImage(currentUser.getId(), file);
			return ResponseEntity.ok(new MessageResponse("Profile image uploaded successfully: " + imageUrl));
		}
	...
	public ResponseEntity<MessageResponse> deleteProfileImage(@AuthenticationPrincipal UserDetailsImpl currentUser) {
