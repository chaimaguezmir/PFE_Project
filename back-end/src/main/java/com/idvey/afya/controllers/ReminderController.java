...
public class ReminderController {
    ...
    public ResponseEntity<ReminderResponse> updateReminderStatus(
            ...
            @Valid @RequestBody UpdateReminderStatusRequest request) {
        ReminderResponse response = reminderService.updateReminderStatus(currentUser.getId(), reminderId, request.getStatus());
    ...
    public ResponseEntity<MessageResponse> deleteReminder(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID reminderId) {
