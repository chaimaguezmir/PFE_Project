...
public class DiseaseController {
	...
	@PostMapping
	public ResponseEntity<DiseaseResponse> createDisease(@AuthenticationPrincipal UserDetailsImpl currentUser,
	...
	@GetMapping
	public ResponseEntity<List<DiseaseResponse>> getAllDiseases(@AuthenticationPrincipal UserDetailsImpl currentUser) {
	...
	@GetMapping("/search")
	public ResponseEntity<List<DiseaseResponse>> searchDiseases(@AuthenticationPrincipal UserDetailsImpl currentUser,
	...
	@GetMapping("/{id}")
	public ResponseEntity<DiseaseResponse> getDiseaseById(@AuthenticationPrincipal UserDetailsImpl currentUser,
