...
public class GroupMedicalController {
    ...
    public ResponseEntity<List<PrescriptionResponse>> getUserPrescriptions(
        ...
        List<PrescriptionResponse> prescriptions = groupMedicalService.getUserPrescriptions(
                currentUser.getId(), groupId, userId);
    ...
    public ResponseEntity<PrescriptionResponse> createPrescriptionForUser(
        ...
        PrescriptionResponse response = groupMedicalService.createPrescriptionForUser(
                currentUser.getId(), groupId, userId, request);
    ...
    public ResponseEntity<PrescriptionResponse> updateUserPrescription(
            ...
            @Valid @RequestBody UpdatePrescriptionRequest request) throws AccessDeniedException {
        PrescriptionResponse response = groupMedicalService.updateUserPrescription(
                currentUser.getId(), groupId, userId, prescriptionId, request);
        return ResponseEntity.ok(response);
    }

    @GroupMedicalDocs.DeleteUserPrescription
    @DeleteMapping("/groups/{groupId}/users/{userId}/prescriptions/{prescriptionId}")
    public ResponseEntity<MessageResponse> deleteUserPrescription(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID groupId,
            @PathVariable UUID userId,
            @PathVariable UUID prescriptionId) throws AccessDeniedException {
        groupMedicalService.deleteUserPrescription(
                currentUser.getId(), groupId, userId, prescriptionId);
    ...
    public ResponseEntity<List<TreatmentResponse>> getAllUserTreatments(
            ...
            @PathVariable UUID groupId,
            @PathVariable UUID userId) throws AccessDeniedException {
        List<TreatmentResponse> treatments = groupMedicalService.getAllUserTreatments(
                currentUser.getId(), groupId, userId);
    ...
    public ResponseEntity<List<TreatmentResponse>> getTreatmentsByPrescription(
            ...
            @PathVariable UUID userId,
            @PathVariable UUID prescriptionId) throws AccessDeniedException {
        List<TreatmentResponse> treatments = groupMedicalService.getTreatmentsByPrescription(
                currentUser.getId(), groupId, userId, prescriptionId);
        return ResponseEntity.ok(treatments);
    }
    ...
    public ResponseEntity<TreatmentResponse> createTreatmentForUser(
        ...
        TreatmentResponse response = groupMedicalService.createTreatmentForUser(
                currentUser.getId(), groupId, userId, request);
        return ResponseEntity.status(HttpStatus.CREATED).body(response);
    }
    ...
    public ResponseEntity<TreatmentResponse> updateUserTreatment(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID groupId,
            @PathVariable UUID userId,
            @PathVariable UUID treatmentId,
            @Valid @RequestBody UpdateTreatmentRequest request) throws AccessDeniedException {
        TreatmentResponse response = groupMedicalService.updateUserTreatment(
                currentUser.getId(), groupId, userId, treatmentId, request);
        return ResponseEntity.ok(response);
    }

    @GroupMedicalDocs.DeleteUserTreatment
    @DeleteMapping("/groups/{groupId}/users/{userId}/treatments/{treatmentId}")
    public ResponseEntity<MessageResponse> deleteUserTreatment(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID groupId,
            @PathVariable UUID userId,
            @PathVariable UUID treatmentId) throws AccessDeniedException {
        groupMedicalService.deleteUserTreatment(
                currentUser.getId(), groupId, userId, treatmentId);
    ...
    public ResponseEntity<List<ReminderWithMedicationResponse>> getUserRemindersWithMedications(
            ...
            @PathVariable UUID groupId,
            @PathVariable UUID userId) throws AccessDeniedException {
        List<ReminderWithMedicationResponse> reminders = groupMedicalService.getUserRemindersWithMedications(
                currentUser.getId(), groupId, userId);
    ...
    public ResponseEntity<List<ReminderResponse>> getUserReminders(
            ...
            @PathVariable UUID groupId,
            @PathVariable UUID userId) throws AccessDeniedException {
        List<ReminderResponse> reminders = groupMedicalService.getUserReminders(
                currentUser.getId(), groupId, userId);
        return ResponseEntity.ok(reminders);
    }
    ...
    public ResponseEntity<List<GroupMemberMedicalOverviewResponse>> getGroupMedicalOverview(
        ...
        List<GroupMemberMedicalOverviewResponse> overview = groupMedicalService.getGroupMedicalOverview(
    ...
    public ResponseEntity<UserMedicalSummaryResponse> getUserMedicalSummary(
            ...
            @PathVariable UUID groupId,
            @PathVariable UUID userId) throws AccessDeniedException {
        UserMedicalSummaryResponse summary = groupMedicalService.getUserMedicalSummary(
                currentUser.getId(), groupId, userId);
