...
public class PurchaseHistoryController {
    ...
    public ResponseEntity<PurchaseHistoryResponse> addPurchaseHistory(
            ...
            @Valid @RequestBody AddPurchaseHistoryRequest request) throws AccessDeniedException {
    ...
    public ResponseEntity<List<PurchaseHistoryResponse>> getPurchaseHistoryByMyMedicine(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID myMedicineId) throws AccessDeniedException {
        List<PurchaseHistoryResponse> history = purchaseHistoryService.getPurchaseHistoryByMyMedicine(currentUser.getId(), myMedicineId);
    ...
    public ResponseEntity<List<PurchaseHistoryResponse>> getPurchaseHistoryByMyMedicineBasic(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID myMedicineId) throws AccessDeniedException {
        List<PurchaseHistoryResponse> history = purchaseHistoryService.getPurchaseHistoryByMyMedicineBasic(currentUser.getId(), myMedicineId);
        return ResponseEntity.ok(history);
    }
    ...
    public ResponseEntity<List<PurchaseHistoryResponse>> getPurchaseHistoryByDateRange(
            ...
            @RequestParam String endDate) throws AccessDeniedException {
        java.time.LocalDateTime start = java.time.LocalDateTime.parse(startDate);
        java.time.LocalDateTime end = java.time.LocalDateTime.parse(endDate);
        List<PurchaseHistoryResponse> history = purchaseHistoryService.getPurchaseHistoryByDateRange(currentUser.getId(), myMedicineId, start, end);
        return ResponseEntity.ok(history);
    }
    ...
    public ResponseEntity<Long> getTotalQuantityPurchased(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID myMedicineId) {
    ...
    public ResponseEntity<Long> getPurchaseHistoryCount(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID myMedicineId) {
    ...
    public ResponseEntity<List<PurchaseHistoryResponse>> getPurchaseHistoryByPharmacyBox(
        ...
        List<PurchaseHistoryResponse> history = purchaseHistoryService.getPurchaseHistoryByPharmacyBox(currentUser.getId(), pharmacyBoxId);
        return ResponseEntity.ok(history);
    }
    ...
    public ResponseEntity<PurchaseHistoryResponse> updatePurchaseHistory(
        ...
        PurchaseHistoryResponse response = purchaseHistoryService.updatePurchaseHistory(currentUser.getId(), id, request);
        return ResponseEntity.ok(response);
    }

    @PurchaseHistoryDocs.DeletePurchase
    @DeleteMapping("/{id}")
    public ResponseEntity<MessageResponse> deletePurchaseHistory(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
