...
public class TreatmentController {
	...
	@PostMapping
	public ResponseEntity<TreatmentResponse> createTreatment(@AuthenticationPrincipal UserDetailsImpl currentUser,
	...
	public ResponseEntity<List<TreatmentResponse>> getTreatmentsByPrescription(
			@AuthenticationPrincipal UserDetailsImpl currentUser, @PathVariable UUID prescriptionId) {
		List<TreatmentResponse> treatments = treatmentService.getTreatmentsByPrescription(currentUser.getId(),
				prescriptionId);
	...
	@PutMapping("/{id}")
	public ResponseEntity<TreatmentResponse> updateTreatment(@AuthenticationPrincipal UserDetailsImpl currentUser,
			@PathVariable UUID id, @Valid @RequestBody UpdateTreatmentRequest request) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<MessageResponse> deleteTreatment(@AuthenticationPrincipal UserDetailsImpl currentUser,
