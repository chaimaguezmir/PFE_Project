...
public class MedicineController {
    ...
    public ResponseEntity<List<MedicineResponse>> findByDosageForm(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
    ...
    public ResponseEntity<MedicineResponse> findByExactName(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
    ...
    public ResponseEntity<MedicineResponse> findByBarcode(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
