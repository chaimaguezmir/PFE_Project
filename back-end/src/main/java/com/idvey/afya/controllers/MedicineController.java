...
public class MedicineController {
	...
	public ResponseEntity<List<MedicineResponse>> findByMedicationType(
			@AuthenticationPrincipal UserDetailsImpl currentUser, @PathVariable String medicationType) {
	...
	public ResponseEntity<MedicineResponse> updateMedicineBarcode(@AuthenticationPrincipal UserDetailsImpl currentUser,
			@PathVariable UUID id, @Valid @RequestBody UpdateMedicineBarcodeRequest request) {
	...
	public ResponseEntity<MedicineResponse> removeMedicineBarcode(@AuthenticationPrincipal UserDetailsImpl currentUser,
			@PathVariable UUID id) {
