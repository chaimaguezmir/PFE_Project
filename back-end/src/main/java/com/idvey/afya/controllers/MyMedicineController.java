...
public class MyMedicineController {
    ...
    @PostMapping
    public ResponseEntity<MyMedicineResponse> createMyMedicine(
    ...
    public ResponseEntity<List<MyMedicineResponse>> getMyMedicinesByPharmacyBox(
        ...
        List<MyMedicineResponse> medicines = myMedicineService.getMyMedicinesByPharmacyBox(currentUser.getId(), pharmacyBoxId);
    ...
    public ResponseEntity<List<MyMedicineResponse>> getMyMedicinesByPharmacyBoxOrdered(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID pharmacyBoxId) throws AccessDeniedException {
        List<MyMedicineResponse> medicines = myMedicineService.getMyMedicinesByPharmacyBoxOrdered(currentUser.getId(), pharmacyBoxId);
        return ResponseEntity.ok(medicines);
    }
    ...
    public ResponseEntity<List<MyMedicineResponse>> searchMyMedicinesInPharmacyBox(
        ...
        List<MyMedicineResponse> medicines = myMedicineService.searchMyMedicinesInPharmacyBox(currentUser.getId(), pharmacyBoxId, name);
        return ResponseEntity.ok(medicines);
    }
    ...
    public ResponseEntity<List<MyMedicineResponse>> findByPharmacyBoxAndForm(
        ...
        List<MyMedicineResponse> medicines = myMedicineService.findByPharmacyBoxAndForm(currentUser.getId(), pharmacyBoxId, form);
        return ResponseEntity.ok(medicines);
    }
    ...
    public ResponseEntity<Long> countMedicinesInPharmacyBox(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID pharmacyBoxId) throws AccessDeniedException {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MyMedicineResponse> updateMyMedicine(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID id,
            @Valid @RequestBody UpdateMyMedicineRequest request) throws AccessDeniedException {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<MessageResponse> deleteMyMedicine(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID id) throws AccessDeniedException {
    ...
    public ResponseEntity<PharmacyBoxMedicinesResponse> getPharmacyBoxMedicines(
            @AuthenticationPrincipal UserDetailsImpl currentUser,
            @PathVariable UUID pharmacyBoxId) throws AccessDeniedException {
        PharmacyBoxMedicinesResponse response = myMedicineService.getPharmacyBoxMedicines(currentUser.getId(), pharmacyBoxId);
        return ResponseEntity.ok(response);
    }
}