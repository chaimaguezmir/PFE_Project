...
public class MyMedicineService {
    ...
    @Transactional
    public MyMedicineResponse createMyMedicine(UUID userId, CreateMyMedicineRequest request) throws AccessDeniedException {
        ...
        if (myMedicineRepository.existsByPharmacyBox_IdAndMedicine_Id(request.getPharmacyBoxId(), request.getMedicineId())) {
    ...
    public List<MyMedicineResponse> getMyMedicinesByPharmacyBox(UUID userId, UUID pharmacyBoxId) throws AccessDeniedException {
    ...
    @Transactional(readOnly = true)
    public List<MyMedicineResponse> getMyMedicinesByPharmacyBoxOrdered(UUID userId, UUID pharmacyBoxId) throws AccessDeniedException {
    ...
    @Transactional(readOnly = true)
    public List<MyMedicineResponse> searchMyMedicinesInPharmacyBox(UUID userId, UUID pharmacyBoxId, String name) throws AccessDeniedException {
    ...
    @Transactional(readOnly = true)
    public List<MyMedicineResponse> findByPharmacyBoxAndForm(UUID userId, UUID pharmacyBoxId, String form) throws AccessDeniedException {
    ...
    public List<MyMedicineResponse> findByMedicineId(UUID medicineId) {
        ...
        return myMedicineRepository.findByMedicine_Id(medicineId)
                .stream()
                .map(this::toResponse)
                .toList();
    }
    ...
    public MyMedicineDetailResponse getMyMedicineDetail(UUID userId, UUID id) throws AccessDeniedException {
        ...
        int totalQuantity = purchaseHistory.stream()
                .mapToInt(PurchaseHistoryResponse::getQuantityPurchased)
                .sum();
        ...
        return new MyMedicineDetailResponse(
                ...
                toMedicineResponse(myMedicine.getMedicine()),
                totalQuantity,
                purchaseHistory,
    ...
    @Transactional
    public MyMedicineResponse updateMyMedicine(UUID userId, UUID id, UpdateMyMedicineRequest request) throws AccessDeniedException {
    ...
    @Transactional(readOnly = true)
    public PharmacyBoxMedicinesResponse getPharmacyBoxMedicines(UUID userId, UUID pharmacyBoxId) throws AccessDeniedException {
