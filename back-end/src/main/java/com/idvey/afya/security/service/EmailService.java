...
public class EmailService {
	...
	public EmailService(JavaMailSender mailSender, SpringTemplateEngine templateEngine,
			@Value("${afya.app.activation.from}") String from, @Value("${afya.app.logo-url}") String logoUrl) {
	...
	public void sendActivationEmail(String to, String name, String code) {
		...
		ctx.setVariable("today", LocalDate.now().format(DateTimeFormatter.ofPattern("d MMM, yyyy", Locale.ENGLISH)));
