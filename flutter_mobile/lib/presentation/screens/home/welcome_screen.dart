...
class TimeButtonSelector extends StatelessWidget {
  ...
  void onTimeButtonTap(BuildContext context, int index) {
    final currentSelectedIndex = context
    ...
    if (currentSelectedIndex == index) {
      ...
      context.read<WelcomeScreenCubit>().updateSelectedTime(-1);
      print('Deselected button at index: $index');
    } else {
      // Select the new button
      context.read<WelcomeScreenCubit>().updateSelectedTime(index);
      print('Selected button at index: $index');
    }
  }
