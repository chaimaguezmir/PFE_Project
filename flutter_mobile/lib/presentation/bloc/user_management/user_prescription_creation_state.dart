// lib/presentation/bloc/user_management/user_prescription_creation_state.dart
part of 'user_prescription_creation_cubit.dart';

class UserPrescriptionCreationState extends Equatable {
  const UserPrescriptionCreationState({
  ...
  // Saved treatments list
  final List<Map<String, dynamic>> treatments;

  UserPrescriptionCreationState copyWith({
    String? userId,
    String? groupId,
    ...
    return UserPrescriptionCreationState(
  ...
  bool get canProceed => isNameValid && hasDiseases && hasUserAndGroup;
